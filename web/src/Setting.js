    ...
    if (category === "Model") {
      return (
        [
          ...
          {id: "ERNIE-Bot 4.0", name: "ERNIE-Bot 4.0"},
          {id: "ERNIE-Bot-8k", name: "ERNIE-Bot-8k"},
          {id: "ERNIE-Bot-turbo-0922", name: "ERNIE-Bot-turbo-0922"},
          {id: "ERNIE-Speed", name: "ERNIE-Speed"},
          {id: "EB-turbo-AppBuilder", name: "EB-turbo-AppBuilder"},
          {id: "ERNIE-3.5-4K-0205", name: "ERNIE-3.5-4K-0205"},
          {id: "ERNIE-3.5-8K-0205", name: "ERNIE-3.5-8K-0205"},
          {id: "ERNIE-3.5-8K-1222", name: "ERNIE-3.5-8K-1222"},
          {id: "Llama-2-7B-Chat", name: "Llama-2-7B-Chat"},
          {id: "Llama-2-13B-Chat", name: "Llama-2-13B-Chat"},
          {id: "Llama-2-70B-Chat", name: "Llama-2-70B-Chat"},
          {id: "ChatGLM2-6B-32K", name: "ChatGLM2-6B-32K"},
          ...
          {id: "XuanYuan-70B-Chat-4bit", name: "XuanYuan-70B-Chat-4bit"},
          {id: "Qianfan-BLOOMZ-7B-compressed", name: "Qianfan-BLOOMZ-7B-compressed"},
          {id: "Qianfan-Chinese-Llama-2-7B", name: "Qianfan-Chinese-Llama-2-7B"},
          {id: "Qianfan-Chinese-Llama-2-13B", name: "Qianfan-Chinese-Llama-2-13B"},
          {id: "ChatLaw", name: "ChatLaw"},
        ]
      );
    } else if (category === "Embedding") {
      return (
