...
func embed(ctx context.Context, client *cohereclient.Client, model *string, inputType *string, texts []string) ([]embedder.Embedding, error) {
	...
	embeddings := make([]embedder.Embedding, len(resp.EmbeddingsFloats.Embeddings))
